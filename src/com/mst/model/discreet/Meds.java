...
public class Meds { //implements Comparable<Meds> {
	...
	private static Pattern FORM_REGEX = Pattern.compile("(?i)(aerosol|cap(sule)?|tab(let)?|cream|gel|gum|lotion|ointment|powder|suppository|syrup|jelly|packet|spray)");
	private static Pattern ROUTE_REGEX = Pattern.compile("(?i)(oral|transdermal|injection|inject|injectable|topical|sublingual|intranasal|rectal|vaginal|urethral|inhalation|inhaler)");
