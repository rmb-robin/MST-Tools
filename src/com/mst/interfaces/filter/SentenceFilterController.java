...
public interface SentenceFilterController {
	List<SentenceQueryResult> getSentenceQueryResults(List<SentenceDiscovery> sentences, String token, List<EdgeQuery> edgeQuery, String searchToken);
	...
	EdgeQueryMapResult convertEdgeQueryToDictionary(SentenceQueryInstance input);
}
